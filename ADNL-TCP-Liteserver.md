...
1. Client should send TL message with scheme `tcp.authentificate nonce:bytes = tcp.Message`, where nonce is 32 random bytes. 
...
5. Server will verify key, signature and nonces and you will be authentificated
