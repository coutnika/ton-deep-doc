...
After successfull handshake, client should start authentification, for liteserver ayn random key can be used, but for some services specific keys can be needed. (example: storage-daemon or validator control).
